<template>
    <div class="container newsl_container">
        ...
        <div class="small">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore voluptatibus minima blanditiis eveniet deserunt, deleniti animi repellat magnam consequatur laudantium.
        </div>
    </div>
</template>
